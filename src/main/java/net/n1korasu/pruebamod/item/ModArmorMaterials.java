...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ESQUIRLADA("esquirla", 37, new int[]{3, 6, 8, 3}, 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> {
        return Ingredient.EMPTY;
    }),

    ESQUIRLADARADIANTE("esquirla", 37, new int[]{3, 6, 8, 3}, 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> {
        return Ingredient.EMPTY;
    })
    ...
    public String getName() {
        return PruebaMod.MOD_ID + ":" + this.name;
    }
